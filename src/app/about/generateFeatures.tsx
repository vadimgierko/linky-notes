...
export default function generateFeatures(props: IconProps) {
	return [
		{
			icon: <CgNotes {...props} />,
			header: "Notes",
		...
		},
		{
			...
			paragraph:
				"This app works in a browser, so all you need is a device (mobile, tablet or laptop) with the Internet connection.",
		},
		{
